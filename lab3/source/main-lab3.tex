...
\end{tabular}
\end{center}\\
\\Продемонстрируем результаты вычислений на графиках. Ниже не приведены графики для функционала $ \text{Ji} (a, \text{mode} \mathbf{X}, \text{mode} \mathbf{Y})$ (7), так как вычисление его значений в каждой из точек выбранного в качестве начального приближения интервала очень долгий и ресурсозатратный процесс.
\newpage
\begin{figure}[h!]
    \centering
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.75\linewidth]{Jaccadrd-all-in-one-A.png}
    \caption{Коеффициент Жаккара для a, все три функционала на одном графике)}
\end{figure}
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.75\linewidth]{Jaccadrd-all-in-one-T.png}
    \caption{Коеффициент Жаккара для t, все три функционала на одном графике}
\end{figure}
